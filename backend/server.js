...
const { connectBull } = require("./configs/redisBull");
...
mongoose.connect(cfg.MONGO.URI)
    ...
    .then(async (client) => {
        ...
        const postQueue = new PostQueue("post-queue", client, { workers: 1 });
        // const bullClient = await connectBull(cfg.REDIS.getUrl());
        // const postQueue = new PostQueue("post-queue", bullClient, { workers: 1 });
